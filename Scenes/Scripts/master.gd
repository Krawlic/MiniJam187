...
const SPLASH_LOGO = preload("res://Scenes/UI/splash.tscn")
const LEVEL_0 = preload("res://Scenes/Levels/level_0.tscn")
...
const ENDSCREEN = preload("res://Scenes/UI/endscreen.tscn")
